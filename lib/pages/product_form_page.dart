...
class _ProductFormPageState extends State<ProductFormPage> {
  ...
  void didChangeDependencies() {
    ...
    if(_formData.isEmpty) {
      final arg = ModalRoute.of(context)?.settings.arguments; /* pegando argumentos da rota para ver se veio de editar produto ou adicionar produto */

      if(arg != null) { /* se tiver argumentos é pq esta vindo de uma tela de edicao, logo, 'e carregado os valores do produto no formulario */
      ...
      body: Padding(
        ...
        child: Form(
            ...
            child: ListView(
              children: [
                TextFormField(
                  initialValue: _formData['name']?.toString(), /* pegando valor caso venha da edição, caso venha da criacao, recebe vazio */
                  /* campo do formulario */
